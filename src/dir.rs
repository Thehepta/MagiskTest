use crate::cstr;
use crate::cstr::{Utf8CStr, Utf8CStrBuf};
use crate::file::{fd_path, fd_set_attr, FsPathBuilder};
use crate::result::{LibcReturn, OsError, OsResult, OsResultStatic};
use libc::{dirent, mode_t, readlinkat, EEXIST, O_CLOEXEC, O_CREAT, O_RDONLY, O_TRUNC, O_WRONLY};
use nix::errno::Errno;
use std::ffi::CString;
use std::fs::File;
